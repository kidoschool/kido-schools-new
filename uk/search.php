   ...
   <div class="container-fluid">
       <div class="row justify-content-center">
           <div class="col-lg-7 py-4">
            <h5 class="head-blue">Explore our global network. We found 8 nurseries</h5>
            <div class="nursery-listing-box">
                ...
                <div class="nursery-img-box col-md-6 col-lg-5 mt-3">
                    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            <img src="https://kido.school/wp-content/uploads/2019/09/Crouch-End-Centre-Pages-2-1.jpg" class="d-block nursery-list-img" alt="...">
                            </div>
                            <div class="carousel-item">
                ...
                <div class="col-lg-7 col-md-6">
                    ...
                    <h3>Greenwich Nursery & Preschool</h3>
            ...
            <div class="nursery-listing-box">
                ...
                <div class="col-lg-7 col-md-6">
                    ...
                    <h3>Clerkenwell Nursery & Preschool</h3>
                    <small id="demo">Kido International Preschool and Day Care (Formerly Safari Kid) is a wonderful 3500 sq ft ...</small>
