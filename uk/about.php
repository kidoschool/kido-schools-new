<?php include 'header.php';?>
      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="banner-tarea">
                <h2 class="banner-text">for parents, by parents</h2>
            </div>
    ...
    <section class="about-text py-5">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8">
          <h1 class="head-text-blue text-center mb-4">About kido</h1>
    ...
    <section class="our-leadership py-5">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-8">
      ...
      <h1 class="head-text-blue text-center mb-2">Our Curriculum</h1>
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <a href="curriculum.php" class="my-btn btn-primary btn-sm center">Find out more</a>
