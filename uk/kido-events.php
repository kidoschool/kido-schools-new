...
<section class="upcoming-events mt-5 mx-4">
    <div class="container"> 
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="data">
                    ...
                    <div class="owl-carousel upcoming-evnts">
                        <div class="card shadow-sm">
                            <img src="https://firebasestorage.googleapis.com/v0/b/kido-events.appspot.com/o/images%2F1649671132827_Large-family-mother-with-child-happy-outdoors-3R4G4EP.jpg?alt=media&token=c62aa55f-c270-4f58-a086-7b855b5405b3" class="card-img-top" alt="...">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="event-time-zone">
                                        <small><strong>Wed May 11</strong></small><br/>
                                        <small> <strong>02:00 PM - 02:45 PM</strong></small><br/>
                                        <small><strong>London Time</strong></small>
                                    </div>
                                    <div class="event-status">
                                        <small class="text-secondary"><strong>Online Event</strong></small>
                                    </div>
                                </div>
                                <h6 class="head-blue subj my-3">Group Coaching Session Online Event: Design My Future</h6>
                                ...
                                <button class="btn-outline-primary btn btn-sm" data-toggle="modal" data-target="#exampleModal">Read More</button>
                            </div>
                        </div>
                        <div class="card shadow-sm">
                            <img src="https://firebasestorage.googleapis.com/v0/b/kido-events.appspot.com/o/images%2F1649671290912_Large-mother-and-son-playing-with-toys-on-floor-at-home-P6X8GDK.jpg?alt=media&token=f5a7bdc9-2440-429e-be1b-3b44a146792e" class="card-img-top" alt="...">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="event-time-zone">
                                        <small><strong>Wed June 8</strong></small><br/>
                                        <small> <strong>02:00 PM - 02:45 PM</strong></small><br/>
                                        <small><strong>London Time</strong></small>
                                    </div>
                                    <div class="event-status">
                                ...
                                <h6 class="head-blue subj my-3">Group Coaching Session Online Event: So What’s Stopping You?</h6>
                                <small class="desc"> Introducing children to your life makes you re-evaluate everything! […]</small>
                                <p class="card-text my-3"><small class="text-muted speaker"><i>Jessamine Ringer </i></small></p>
                        ...
                        <!-- <div class="card shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="event-time-zone">
                                        <small><strong>Wed Apr 6</strong></small><br/>
                                        <small> <strong>02:00 PM - 02:45 PM</strong></small><br/>
                                        <small><strong>London Time</strong></small>
                                    </div>
                                    <div class="event-status">
...
<section class="past-events mt-5 mx-4">
    <div class="container"> 
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="data">
